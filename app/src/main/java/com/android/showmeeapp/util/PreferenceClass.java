...
public class PreferenceClass {
	...
	private static String SHOW_MEE_PREFERENCE;

	public static void setStringPreference(Context context, String name, String value) {
		appContext = context;
		SharedPreferences settings = context.getSharedPreferences(SHOW_MEE_PREFERENCE, 0);
	...
	public static void clearPreference(Context context) {
		SharedPreferences preferences = context.getSharedPreferences(SHOW_MEE_PREFERENCE, 0);

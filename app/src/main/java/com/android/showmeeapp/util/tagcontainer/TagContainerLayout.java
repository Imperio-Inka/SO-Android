package com.android.showmeeapp.util.tagcontainer;
...
public class TagContainerLayout extends ViewGroup {
	 ...
	 */
	private int mTagBackgroundColor = Color.parseColor("#00ffffff");
	/**
	...
	private int mSelectedTagBorderColor = Color.parseColor("#000000");
	private int mSelectedTagBackgroundColor = Color.parseColor("#a5a49f");
	private int mSelectedTagTextColor = Color.parseColor("#000000");
	/**
	 * View theme(default PURE_CYAN)
	 */
	private int unSelectedTag = 100;
	//private int mTheme = ColorFactory.PURE_CYAN;
	private int selectedTag = 200;
	private int mTheme = unSelectedTag;
	...
	private void init(Context context, AttributeSet attrs, int defStyleAttr) {
		TypedArray attributes = context.obtainStyledAttributes(attrs, co.lujun.androidtagview.R.styleable.AndroidTagView,
				defStyleAttr, 0);
		mVerticalInterval = (int) attributes.getDimension(co.lujun.androidtagview.R.styleable.AndroidTagView_vertical_interval,
				dp2px(context, DEFAULT_INTERVAL));
		mHorizontalInterval = (int) attributes.getDimension(co.lujun.androidtagview.R.styleable.AndroidTagView_horizontal_interval,
				dp2px(context, DEFAULT_INTERVAL));
		mBorderWidth = attributes.getDimension(co.lujun.androidtagview.R.styleable.AndroidTagView_container_border_width,
				dp2px(context, mBorderWidth));
		mBorderRadius = attributes.getDimension(co.lujun.androidtagview.R.styleable.AndroidTagView_container_border_radius,
				dp2px(context, mBorderRadius));
		mTagBdDistance = attributes.getDimension(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_bd_distance,
				mTagBdDistance);
		mBorderColor = attributes.getColor(co.lujun.androidtagview.R.styleable.AndroidTagView_container_border_color,
				mBorderColor);
		mBackgroundColor = attributes.getColor(co.lujun.androidtagview.R.styleable.AndroidTagView_container_background_color,
				mBackgroundColor);
		mDragEnable = attributes.getBoolean(co.lujun.androidtagview.R.styleable.AndroidTagView_container_enable_drag, false);
		mSensitivity = attributes.getFloat(co.lujun.androidtagview.R.styleable.AndroidTagView_container_drag_sensitivity,
				mSensitivity);
		mGravity = attributes.getInt(co.lujun.androidtagview.R.styleable.AndroidTagView_container_gravity, mGravity);
		mTagMaxLength = attributes.getInt(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_max_length, mTagMaxLength);
		mTheme = attributes.getInt(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_theme, mTheme);
		mTagBorderWidth = attributes.getDimension(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_border_width,
				dp2px(context, mTagBorderWidth));
		mTagBorderRadius = attributes.getDimension(
				co.lujun.androidtagview.R.styleable.AndroidTagView_tag_corner_radius, dp2px(context, mTagBorderRadius));
		mTagHorizontalPadding = (int) attributes.getDimension(
				co.lujun.androidtagview.R.styleable.AndroidTagView_tag_horizontal_padding, mTagHorizontalPadding);
		mTagVerticalPadding = (int) attributes.getDimension(
				co.lujun.androidtagview.R.styleable.AndroidTagView_tag_vertical_padding, mTagVerticalPadding);
		mTagTextSize = attributes.getDimension(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_text_size,
				sp2px(context, mTagTextSize));
		mTagBorderColor = attributes.getColor(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_border_color,
				mTagBorderColor);
		mTagBackgroundColor = attributes.getColor(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_background_color,
				mTagBackgroundColor);
		mTagTextColor = attributes.getColor(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_text_color, mTagTextColor);
		mTagTextDirection = attributes.getInt(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_text_direction, mTagTextDirection);
		isTagViewClickable = attributes.getBoolean(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_clickable, false);
		attributes.recycle();
...
//        int widthSpecMode = MeasureSpec.getMode(widthMeasureSpec);
	...
	private int[] onUpdateColorFactory() {
		int[] colors;
		if (mTheme == selectedTag) {
			colors = new int[]{mSelectedTagBackgroundColor, mSelectedTagBorderColor, mSelectedTagTextColor};
		} else {
			colors = new int[]{mTagBackgroundColor, mTagBorderColor, mTagTextColor};
		}
		return colors;
